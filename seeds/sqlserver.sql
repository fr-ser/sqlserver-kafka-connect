...
EXEC sys.sp_cdc_enable_table @source_schema = 'dbo', @source_name = 'ship', @role_name = NULL, @supports_net_changes = 0;
...
EXEC sys.sp_cdc_enable_table @source_schema = 'dbo', @source_name = 'train', @role_name = NULL, @supports_net_changes = 0;
